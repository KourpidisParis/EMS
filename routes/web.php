...
Route::group(['middleware'=>['auth','has.permission']],function(){
    ...
    Route::post('accept-reject-leave','App\Http\Controllers\LeaveController@acceptReject')->name('accept.reject');

    Route::get('/mail','App\Http\Controllers\MailController@create')->name('mails.create');
    Route::get('/mail','App\Http\Controllers\MailController@store')->name('mails.store');
